...
async function queryRunner(graphqlRunner, queryJob, parentSpan) {
  ...
  if (resultHash !== (await resultHashCache.get(queryJob.id)) || queryJob.queryType === `page` && !(0, _pageData.pageDataExists)(_path.default.join(program.directory, `public`), queryJob.id)) {
